...
function setup(){
    ...
    wall5 = createSprite(200,39,400,4); 
    
    leftbutton = createSprite(150,392,50,35); 
    leftbutton.addImage(leftbutton_image);
    leftbutton.scale=0.20;

    rightbutton = createSprite(250,390,50,35);  
    rightbutton.addImage(rightbutton_image);
    rightbutton.scale=0.20;

    resetbutton = createSprite(355,20,40,25);  
    resetbutton.addImage(reset_image);
    resetbutton.scale=0.20;

  
    trophy = createSprite(200,120,200,210);
    trophy.addImage(trophy_image);
    trophy.scale=0.55;
    trophy.visible=false;


    youwin = createSprite(200,250,200,210);
